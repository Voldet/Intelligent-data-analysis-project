...
\begin{center}
\begin{figure}[hbtp]
{\centering {\includegraphics[width=0.6\linewidth,angle=0]{logo/label2.png}}\par}
...
\begin{center}
\begin{figure}[h]
{\centering {\includegraphics[width=0.7\linewidth,angle=0]{logo/2D_eigen_ratio.png}}\par}
\end{figure}
...
\begin{center}
\begin{figure}[h]
{\centering {\includegraphics[width=0.7\linewidth,angle=0]{logo/knee_point.png}}\par}
\end{figure}
...
\begin{center}
\begin{figure}[h]
{\centering {\includegraphics[width=0.7\linewidth,angle=0]{logo/2D_PCA.png}}\par}
\end{figure}
...
\begin{center}
\begin{figure}[h]
{\centering {\includegraphics[width=0.7\linewidth,angle=0]{logo/3D_PCA_ex_quality.png}}\par}
\end{figure}
...
\begin{center}
\begin{figure}[h]
{\centering {\includegraphics[width=0.7\linewidth,angle=0]{logo/2D_SOM_30.png}}\par}
\end{figure}
...
\begin{center}
\begin{figure}[h]
{\centering {\includegraphics[width=0.7\linewidth,angle=0]{logo/2D_SOM_50.png}}\par}
\end{figure}
